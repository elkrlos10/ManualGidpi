...
if (window.require) {
  ...
  require.config({
    paths: {
      "highlight": "scripts/highlight",
      "jquery": "scripts/jquery-1.10.2" // 1.11.3
  ...
  function goLoadSrc(filenames) {
    ...
    for (var i = 0; i < arguments.length; i++) {
      ...
      selt.async = false;
      selt.defer = false;
      selt.src = "scripts/" + filename;
      script.parentNode.insertBefore(selt, script.nextSibling);
      script = selt;
    }
  }
  goLoadSrc("highlight.js", (window.jQuery ? "" : "jquery-1.10.2.js"), "bootstrap.js");
}
